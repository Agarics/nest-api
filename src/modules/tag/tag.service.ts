...
export class TagService {
  ...
  public async getAllTags(options: {
  ...
  public async paginator(
    ...
    const tags = await this.tagModel.paginate(query, {
      ...options,
      lean: true,
    });
  ...
  public async create(newTag: Tag): Promise<MongooseDoc<Tag>> {
    const existedTag = await this.tagModel
  ...
  public async update(
    ...
    const tag = await this.tagModel
      .findByIdAndUpdate(tagId, newTag as any, { new: true })
      .exec();
    if (!tag) {
  ...
  public async batchDelete(tagIds: MongooseId[]): Promise<any> {
